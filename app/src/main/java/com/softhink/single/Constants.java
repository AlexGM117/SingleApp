...
public class Constants {
    ...
    public static final String PERFILFRAGMENT = PerfilFragment.class.getSimpleName();
    public static final String PLACESFRAGMENT = PlacesFragment.class.getSimpleName();
    public static final String LOGINCOMMONFRAGMENT = LoginCommonFragment.class.getSimpleName();
    public static final String LOGINFRAGMENT = LoginFragment.class.getSimpleName();
    public static final String PASSRECOVERYFRAGMENT = PassRecoveryFragment.class.getSimpleName();
